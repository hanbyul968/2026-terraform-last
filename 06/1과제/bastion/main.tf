...
# =============================================================================
# ë£¨íŠ¸(1ê³¼ì œ) ì½”ë“œ ë²ˆë“¤ë§???ë¶€?¸ìŠ¤?¸ë© S3 ?…ë¡œ??#  - source_dir : ?ìœ„ 1ê³¼ì œ ?´ë”(?„ì¬ ë¡œì»¬ ?Œì¼; modules/docker/manifest ?¬í•¨)
#  - ?œì™¸       : bastion ?´ë”, .terraform, state, lock, plan (ë¦¬ëˆ…?¤ì—???ˆë¡œ init)
#  - ë²ˆë“¤ zip ?€ 1ê³¼ì œ ?´ë” "ë°?(06/)???ì„±?˜ì—¬ ?ê¸° ?ì‹ ???¬í•¨?˜ì? ?Šê²Œ ?œë‹¤.
# =============================================================================
