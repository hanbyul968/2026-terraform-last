...
#   - 자동화: 루트(../) 1과제 코드(application/static/k8s 포함)를 zip 으로 묶어
...
#  - 제외       : bastion 폴더, .terraform, state/backup, lock, plan, terraform/ 하위
#                 (리눅스에서 새로 init). application/static/files/k8s 는 포함 유지.
#  - 번들 zip 은 1과제 폴더 "밖"(05/)에 생성하여 자기 자신을 포함하지 않게 한다.
# =============================================================================
